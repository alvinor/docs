...
1. [op_url_log 系统-日志表](#op_url_log)
 ...
 #### cash_collect_case 催收推送记录表<span 'id'=">#cash_collect_case">cash_collect_case</span>
...
#### cash_collection_case 催收推送记录表<span 'id'=">#cash_collection_case">cash_collection_case</span>
...
#### cash_confirm_record 认款记录表<span 'id'=">#cash_confirm_record">cash_confirm_record</span>
...
#### cash_credit_result 新网征信变量<span 'id'=">#cash_credit_result">cash_credit_result</span>
...
#### cash_crm_record 电商log表<span 'id'=">#cash_crm_record">cash_crm_record</span>
...
#### cash_export_log excel导出日志表<span 'id'=">#cash_export_log">cash_export_log</span>
...
#### cash_face_ocr 身份证OCR图片识别认证<span 'id'=">#cash_face_ocr">cash_face_ocr</span>
...
#### cash_hand_loan_record 手动放款日志记录<span 'id'=">#cash_hand_loan_record">cash_hand_loan_record</span>
...
#### cash_loan_day_record 每日放款金额记录<span 'id'=">#cash_loan_day_record">cash_loan_day_record</span>
...
#### cash_loan_setting 放款配置<span 'id'=">#cash_loan_setting">cash_loan_setting</span>
...
#### cash_loan_setting_record 放款配置日志记录<span 'id'=">#cash_loan_setting_record">cash_loan_setting_record</span>
...
#### cash_make_loan_record 放款请求日志<span 'id'=">#cash_make_loan_record">cash_make_loan_record</span>
...
#### cash_order 业务订单<span 'id'=">#cash_order">cash_order</span>
...
#### cash_order_copy1 业务订单<span 'id'=">#cash_order_copy1">cash_order_copy1</span>
...
#### cash_order_extend 业务订单扩展表<span 'id'=">#cash_order_extend">cash_order_extend</span>
...
#### cash_order_loan_lock 放款提交lock表<span 'id'=">#cash_order_loan_lock">cash_order_loan_lock</span>
...
#### cash_order_status_record 订单状态轨迹<span 'id'=">#cash_order_status_record">cash_order_status_record</span>
...
#### cash_product 金融产品表<span 'id'=">#cash_product">cash_product</span>
...
#### cash_repay_plan 还款计划表<span 'id'=">#cash_repay_plan">cash_repay_plan</span>
...
#### cash_reports_log 用户统计日报记录表<span 'id'=">#cash_reports_log">cash_reports_log</span>
...
#### cash_sms_log 短信log表<span 'id'=">#cash_sms_log">cash_sms_log</span>
...
#### cash_sms_task 短信任务表<span 'id'=">#cash_sms_task">cash_sms_task</span>
...
#### cash_trade_flow 交易流水表<span 'id'=">#cash_trade_flow">cash_trade_flow</span>
...
13|status|tinyint(4)|NO||3|交易结果。-33-退款中，－4-已退款，-5-退款失败，-3-请求异常，-2-退汇，-1-交易失败，0-等待交易，1-交易中，2-交易成功，3-待处理（还未交由支付渠道处理），4-处理中（已交由支付渠道处理，还
未返回处理结果）
...
#### cash_trade_flow_extend 交易流水扩展表<span 'id'=">#cash_trade_flow_extend">cash_trade_flow_extend</span>
...
#### cash_user 白名单用户表<span 'id'=">#cash_user">cash_user</span>
...
#### cash_user_bill 用户总账<span 'id'=">#cash_user_bill">cash_user_bill</span>
...
#### cash_user_card 用户银行卡<span 'id'=">#cash_user_card">cash_user_card</span>
...
#### cash_user_contract 电子签结果表<span 'id'=">#cash_user_contract">cash_user_contract</span>
...
#### cash_user_copy 白名单用户表<span 'id'=">#cash_user_copy">cash_user_copy</span>
...
#### cash_user_extend 用户扩展表<span 'id'=">#cash_user_extend">cash_user_extend</span>
...
#### cash_user_face 用户人脸识别<span 'id'=">#cash_user_face">cash_user_face</span>
...
#### cash_user_quota 用户额度申请成功的结果表（用户产品额度表）<span 'id'=">#cash_user_quota">cash_user_quota</span>
...
#### cash_user_quota_apply 额度申请log表<span 'id'=">#cash_user_quota_apply">cash_user_quota_apply</span>
...
#### cash_verification_detail 核销详情表<span 'id'=">#cash_verification_detail">cash_verification_detail</span>
